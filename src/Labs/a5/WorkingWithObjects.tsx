...
function WorkingWithObjects() {
  const ASSIGNMENT_URL = "https://kanbas-node-server-app-367k.onrender.com/a5/assignment";
  ...
  return (
    <div>
      ...
      <a className="btn btn-primary" href="https://kanbas-node-server-app-367k.onrender.com/a5/assignment">
        Get Assignment
      </a>
      <h4>Retrieving Properties</h4>
      <a
        className="btn btn-primary"
        href="https://kanbas-node-server-app-367k.onrender.com/a5/assignment/title"
      >
        Get Title
      </a>
    </div>
